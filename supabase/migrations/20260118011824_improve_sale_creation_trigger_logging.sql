/*
  # Melhorar Trigger de Criação de Venda com Logs e Tratamento de Erros
  
  1. Melhorias
    - Adicionar verificação de venda existente antes de tentar criar
    - Melhorar mensagens de log para facilitar debug
    - Tratar possível erro de constraint única
  
  2. Comportamento
    - Se já existe venda: apenas marca sale_created = true e retorna
    - Se não existe: cria normalmente
    - Logs claros em todas as situações
*/
